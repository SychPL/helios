...
final class Telemetry {
    final String appVersion,voiceState,padVersion;
    final int versionCode;
    final long uptimeSeconds;
    final Boolean dockConnected,charging,ledOn;
    final Integer ledBrightness,volumePercent;
    Telemetry(String appVersion,int versionCode,String voiceState,Boolean dockConnected,Boolean charging,Boolean ledOn,Integer ledBrightness,String padVersion,Integer volumePercent,long uptimeSeconds){
    ...
    JSONObject fingerprint(){
        try{
            return new JSONObject().put("app_version",appVersion).put("version_code",versionCode).put("voice_state",voiceState)
                ...
                .put("pad_version",nul(padVersion)).put("volume_percent",nul(volumePercent));
