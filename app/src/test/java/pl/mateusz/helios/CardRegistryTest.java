...
public class CardRegistryTest {
    @Test public void everyDefinedTypeHasABodyAndNothingElseDoes(){
        ...
        assertEquals(Arrays.asList("clock","weather","entity","light","cover","garage","music","cover_group","tile","climate","alerts","energy"),new ArrayList<>(CardDefinition.ALL.keySet()));
    }
